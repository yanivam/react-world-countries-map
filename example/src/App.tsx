      ...
      < div className="Main">
        <table>
          <tbody>
            <tr>
              <td>
                <ReactWorldCountriesMap color="red" title="Top 10 Populous Countries" value-suffix="people" size="lg" data={data1} />
              </td>
              <td>
                <ReactWorldCountriesMap color="green" title="Top 10 GDP per Capita" value-prefix="$" size="lg" data={data2} />
              </td>
            </tr>
          </tbody>
        </table>
